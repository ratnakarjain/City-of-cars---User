                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      GestureDetector(
                                        onTap: widget.ordersPlans.length < 3
                                            ? () {}
                                            : () {
                                                dropvalue = index + 1;
                                                          ...
                                                          children: [
                                                            Center(
                                                              child: ListView
                                                                ...
                                                                itemCount: order
                                                                    .list!
                                                                    .length, //data[index]["Plans"]["services_id"].length > 3 ? 3 : data[index]["Plans"]["services_id"].length,
                                                                scrollDirection:
                                                                    Axis.horizontal,
                                                                shrinkWrap:
                                                                    true,
                          ...
                          child: Positioned(
                            ...
                            child: Container(
                              ...
                              child: GridView.count(
                                  ...
                                  children: List.generate(order.list!.length,
                                      // data[index]["Plans"]
                                      //         ["services_id"]
                                      //     .length,
                                      (indexx) {
                                    return Column(
                                      children: [
                                        CachedNetworkImage(
                                            fit: BoxFit.fill,
                                            height: h * 0.03,
                                            imageUrl: order.list![indexx].image
                                                .toString(),
                                            //  data[index][
                                            //                 "Plans"]
                                            //             [
                                        ...
                                        // ),
                                        Text(
                                          order.list![indexx].name.toString(),
                                          // data[index]["Plans"][
                                          //             "services_id"]
                                          //         [
                                          //         indexx]["title"]

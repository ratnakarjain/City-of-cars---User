          ...
          : loading
              ...
              : SingleChildScrollView(
                  ...
                  child: Container(
                    height: h * 0.89 +
                        (extend
                            ? (h * 0.08 * (carHealthModel.carparts.length - 3))
                            : 0),
                    width: w,
                    child: Stack(
                      children: [
                        Container(
                          width: w,
                          margin:
                              EdgeInsets.only(top: h * 0.02, bottom: h * 0.05),
                        ...
                        Container(
                          width: w,
                          margin:
                              EdgeInsets.only(top: h * 0.02, bottom: h * 0.36),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.only(
                                bottomLeft: Radius.circular(h * 0.07)),
                        ...
                        Container(
                          ...
                          // height: h*0.32,
                          margin:
                              EdgeInsets.only(top: h * 0.02, bottom: h * 0.55),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.only(
                                bottomLeft: Radius.circular(h * 0.07)),
                            color: kwhitecolor,
                                        ...
                                        children: [
                                          Expanded(
                                            child: CircleAvatar(
                                              radius: h * 0.01,
                                              backgroundColor:
                                                  currentColor, // color[Random().nextInt(3)],
                                            ),
                                          ),
                                          Expanded(
                                            flex: 4,
